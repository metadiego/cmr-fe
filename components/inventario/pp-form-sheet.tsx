...
// Alta/edición de una presentación de proveedor (AMP) para un producto. Cuando cambia
// el proveedor o la presentación, se agrega un AMP nuevo — no se edita el producto.
export function PPFormSheet({
  ...
  // Re-seed when the target changes / sheet reopens.
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="flex w-full flex-col overflow-y-auto sm:max-w-md">
        ...
        <div className="grid gap-4 px-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Field label={t("field.factorABase")}>
              <Input
                inputMode="decimal"
...
// Select de catálogo con opción "ninguno". Si el catálogo está vacío, solo ofrece
// "ninguno" (los catálogos del BE pueden no estar sembrados aún).
