                  ...
                  <div className="space-y-1 px-1.5">
                    {g.alertas.map((a) => {
                      ...
                      return (
                        <div
                          key={a.id}
                          className="group flex items-start gap-2 rounded-lg bg-card px-2.5 py-2 shadow-sm shadow-[rgba(16,32,64,0.06)] ring-1 ring-foreground/10 transition-colors hover:bg-accent/50"
                        >
